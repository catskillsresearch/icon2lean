...
$$\begin{aligned}
&\mathbin{⨸}(a, b) \Leftarrow \Uparrow \text{proc}(\text{"div"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 2)(a, b) \ \blacksquare
\end{aligned}$$
...
$$\begin{aligned}
&\mathbf{0}(a) \Leftarrow \Uparrow \text{proc}(\text{"zero"}\_\text{""}\mathrel{\texttt{||}}\text{type}(a), 1)(a) \ \blacksquare \\
&\mathbf{1}(a) \Leftarrow \Uparrow \text{proc}(\text{"one"}\_\text{""}\mathrel{\texttt{||}}\text{type}(a), 1)(a) \ \blacksquare
\end{aligned}$$
...
$$\begin{aligned}
&\text{Abs}(a) \Leftarrow \Uparrow \text{proc}(\text{"Abs"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 1)(a) \ \blacksquare \\
&\oplus(a, b) \Leftarrow \Uparrow \text{proc}(\text{"plus"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 2)(a, b) \ \blacksquare \\
&\ominus(a, b) \Leftarrow \Uparrow \oplus(a, -(b)) \ \blacksquare \\
&- (x) \Leftarrow \Uparrow \text{proc}(\text{"minus"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(x), 2)(x) \ \blacksquare \\
&\otimes(a, b) \Leftarrow \Uparrow \text{proc}(\text{"times"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 2)(a, b) \ \blacksquare \\
&\mathbin{⨸}(a, b) \Leftarrow \Uparrow \text{proc}(\text{"div"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 2)(a, b) \ \blacksquare \\
&\text{mod}(a, b) \Leftarrow \\
&\quad \textbf{if } (x := \text{proc}(\text{"mod"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 2)(a, b)) \textbf{ then } \Uparrow x \\
...
&\quad \Uparrow (\textbf{if } (x := \text{proc}(\text{"rem"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(a), 2)(a, b)) \textbf{ then } x \\
...
&\textit{bx} := \text{poly}\_\text{of}(\mathcal{Q}(2,1))
\end{aligned}$$
...
&\quad \textbf{if } (x := \text{proc}(\text{"normalize"}\_\text{""}\mathrel{\texttt{||}}\text{type}(a), 1)(a)) \textbf{ then } \Uparrow x \\
...
$$\begin{aligned}
&= (a, b) \Leftarrow \Uparrow \text{proc}(\text{"equal"}\_\text{""}\mathrel{\texttt{||}}\text{type}(a), 2)(a, b) \ \blacksquare \\
&< (a, b) \Leftarrow \Uparrow ((\text{proc}(\text{"less"}\_\text{""}\mathrel{\texttt{||}}\text{type}(a), 2)(a, b)) \mathrel{|} <0(\ominus(a, b))) \ \blacksquare \\
&<0 (x) \Leftarrow \Uparrow \text{proc}(\text{"negative"}\_\text{""}\mathrel{\texttt{||}}\text{type}(x), 1)(x) \ \blacksquare \\
&\mathit{unit}\,(x) \Leftarrow \Uparrow \text{proc}(\text{"unit"}\_\text{""}\mathrel{\texttt{||}}\text{type}(x), 1)(x) \ \blacksquare \\
&=0 (x) \Leftarrow \Uparrow \text{proc}(\text{"is"}\_\text{"zero"}\_\text{""}\mathrel{\texttt{||}}\text{type}(x), 1)(x) \ \blacksquare
\end{aligned}$$
...
&\quad \textbf{else if } pp := \text{proc}(\text{"print"}\_\text{""}\mathrel{\texttt{||}}\,\text{type}(x), 1) \textbf{ then } pp(x) \\
...
&\text{pr}\{\text{"QZ[x]: MOD}\_\text{RS("},\ ax,\ \text{", "},\ bx,\ \text{") = "},\ MOD\_RS(ax, bx)\} \\
&showtime() \\
\end{aligned}$$
...
$QZ[x]\text{: MOD}\_\text{RS}(2zq + (-1z)q \cdot X + 3zq \cdot X^2 + 2zq \cdot X^4 + 1zq \cdot X^5,\ 2zq + (-1z)q \cdot X + 3zq \cdot X^3)$  
...
&\quad \textbf{if } not(y \mathrel{:=} proc(\text{"do"}\_\text{""} \ \mathrel{\texttt{||}} \ command, 2)) \\
...
&\quad \{ x \mathrel{:=} (upto((\&lcase \mathrel{+{+}} \&ucase \mathrel{+{+}} \text{'}\_\text{'0123456789'}), line) \ | \ (\texttt{*}line + 1)) \\
&\quad\quad \textbf{if } x = \texttt{*}line + 1 \textbf{ then } \{ writes(line);\ break \} \\
&\quad\quad y \mathrel{:=} (upto(\mathord{\sim}(\&lcase \mathrel{+{+}} \&ucase \mathrel{+{+}} \text{'}\_\text{'0123456789'}), line) \ | \ (\texttt{*}line + 1)) \\
